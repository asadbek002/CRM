...
export default function NewOrder() {
    ...
    return (
        <form onSubmit={onSubmit} className="grid grid-cols-2 gap-4 max-w-3xl">
            <h2 className="text-xl col-span-2">Buyurtma kiritish</h2>
            ...
            <div>
                ...
                <select
                    ...
                    onChange={(e) => (e.target.value === '' ? setBranchId('') : setBranchId(Number(e.target.value)))}
                >
                    <option value="">— tanlang —</option>
